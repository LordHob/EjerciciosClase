...
const Op = db.Sequelize.Op; //Import all ORM sequelize functions (Funciones propias de Sequelize)
...
CategoryController.deleteAll = (req, res) => {
    category.destroy({
      where: {},
      truncate: false //Que nos elimine los registros, pero no la tabla
    })
      .then(nums => {
